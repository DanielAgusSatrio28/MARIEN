function startFarewell() {
    ...
    // Ganti pesan
    message.textContent = "LORD MARRIEN";
    subMessage.textContent = "Selamat datang di dunia penuh kemewahan dan keindahan, karena engkau memang layak jadi sang Ratu!Seperti kilau berlian, kamu selalu bersinar dengan pesona yang tak bisa dipandang sebelah mata. Setiap langkahmu membawa kebahagiaan, setiap senyummu menciptakan keajaiban. 🌟Terima kasih sudah menjadi sosok yang luar biasa, penuh inspirasi dan kebaikan. Kamu bagaikan bunga di taman yang selalu mekar, dengan hati yang lembut dan sikap yang penuh kasih. 🌸💕 ";
